...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, :servico => { :codServ => @servico.codServ, :dtEntrada => @servico.dtEntrada, :dtEntrega => @servico.dtEntrega, :id => @servico.id, :idCliente => @servico.idCliente, :idEquipamento => @servico.idEquipamento }
    end
  ...
  test "should update servico" do
    put :update, :id => @servico, :servico => { :codServ => @servico.codServ, :dtEntrada => @servico.dtEntrada, :dtEntrega => @servico.dtEntrega, :id => @servico.id, :idCliente => @servico.idCliente, :idEquipamento => @servico.idEquipamento }
    assert_redirected_to servico_path(assigns(:servico))
  end
